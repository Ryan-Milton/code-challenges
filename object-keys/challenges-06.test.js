...
const totalCharacters = (arr) => {
  // Solution code here...
  let chars =  Object.values(characters[0]);
  return chars.length+chars[2].length-2;
}
...
//////WAM BAM HOT DAMN! FIGURED IT OUT!
...
const hasChildrenValues = (arr, character) => {
  ...
  for(let i = 0; i < characters.length; i++){
    console.log(Object.values(characters[i].children));
  }
}
